...
class DetailKamarController extends BaseController
{
    ...
    public function add_detail_kamar()
    {
        ...
        return redirect()->to(base_url('Admin/DetailKamarController/view/'));
    }
    ...
    public function update_detail_kamar()
    {
        ...
        return redirect()->to(base_url('Admin/DetailKamarController/view/' . $id_kamar));
    }
    ...
    public function delete_detail_kamar()
    {
        ...
        return redirect()->to('/Admin/DetailKamarController/view/' . $id_kamar);
    }
