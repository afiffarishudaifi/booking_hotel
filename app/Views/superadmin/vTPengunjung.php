...
<body>
    ...
    <div id="page-container"
        ...
        <form action="<?php echo base_url('SuperAdmin/Pengunjung/delete_pengguna'); ?>" method="post">
    ...
    <!-- Modal Add Class-->
    <form action="<?php echo base_url('SuperAdmin/Pengunjung/add_pengguna'); ?>" method="post" id="form_add" data-parsley-validate="true" enctype="multipart/form-data">
    ...
    <!-- Modal Edit Class-->
    <form action="<?php echo base_url('SuperAdmin/Pengunjung/update_pengguna'); ?>" method="post" id="form_edit" data-parsley-validate="true" enctype="multipart/form-data">
    ...
    <script type="text/javascript">
            ...
            $("#input_email").keyup(function(){
                ...
                if(input_email != ''){
                    $.ajax({
                        type: 'GET',
                        dataType: 'json',
                        url: '<?php echo base_url('SuperAdmin/Pengunjung/cek_email'); ?>' + '/' + input_email,
        ...
        function detail_edit(isi) {
            $.getJSON('<?php echo base_url('SuperAdmin/Pengunjung/data_edit'); ?>' + '/' + isi, {},
                function(json) {
