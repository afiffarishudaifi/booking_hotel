...
<body>
    ...
    <div id="page-container"
        ...
        <form action="<?php echo base_url('SuperAdmin/Kamar/delete_kamar'); ?>" method="post">
        ...
        <form action="<?php echo base_url('SuperAdmin/Kamar/add_kamar'); ?>" method="post" id="form_add" data-parsley-validate="true">
        ...
        <!-- Modal Edit Class-->
        <form action="<?php echo base_url('SuperAdmin/Kamar/update_kamar'); ?>" method="post" id="form_edit" data-parsley-validate="true">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#input_nama").keyup(function(){
                ...
                if(nama != ''){
                    $.ajax({
                        type: 'GET',
                        dataType: 'json',
                        url: '<?php echo base_url('SuperAdmin/Kamar/cek_nama'); ?>' + '/' + nama,
            ...
            $("#input_kategori").select2({
                ...
                theme: 'bootstrap4',
                ajax: {
                    url: '<?php echo base_url('SuperAdmin/Kamar/data_kategori'); ?>',
                    type: "post",
                    delay: 250,
                    dataType: 'json',
        ...
        function detail_edit(isi) {
            $.getJSON('<?php echo base_url('SuperAdmin/Kamar/data_edit'); ?>' + '/' + isi, {},
                function(json) {
