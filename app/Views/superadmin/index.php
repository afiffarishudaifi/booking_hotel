			...
			<div class="row">
				...
				<div class="col-xl-3 col-md-6">
					<div class="widget widget-stats bg-blue">
						...
						<div class="stats-link">
							<a href="<?= base_url('SuperAdmin/Pengguna'); ?>">View Detail <i class="fa fa-arrow-alt-circle-right"></i></a>
						</div>
					</div>
				</div>
				<!-- end col-3 -->
				...
				<div class="col-xl-3 col-md-6">
					<div class="widget widget-stats bg-info">
						...
						<div class="stats-link">
							<a href="<?= base_url('SuperAdmin/Kamar'); ?>">View Detail <i class="fa fa-arrow-alt-circle-right"></i></a>
						</div>
					</div>
				</div>
				<!-- end col-3 -->
				...
				<div class="col-xl-3 col-md-6">
					<div class="widget widget-stats bg-red">
						...
						<div class="stats-link">
							<a href="<?= base_url('SuperAdmin/Laporan'); ?>">View Detail <i class="fa fa-arrow-alt-circle-right"></i></a>
						</div>
					</div>
				</div>
				<!-- end col-3 -->
				...
				<div class="col-xl-12">
					...
					<div class="panel panel-warning" data-sortable-id="index-1">
						...
						<div class="panel-body pr-1">
	                        <form action="<?php echo base_url('SuperAdmin/dashboard') ?>" method="POST" id="filter_form">
	                            <?= csrf_field(); ?>
	                            <div class="form-row">
