...
<body>
    ...
    <div id="page-container"
        ...
        <form action="<?php echo base_url('SuperAdmin/Kategori/delete_kategori_kamar'); ?>" method="post" autocomplete="off">
    ...
    <!-- Modal Add Class-->
    <form action="<?php echo base_url('SuperAdmin/Kategori/add_kategori_kamar'); ?>" method="post" id="form_add" data-parsley-validate="true"  autocomplete="off">
    ...
    <!-- Modal Edit Class-->
    <form action="<?php echo base_url('SuperAdmin/Kategori/update_kategori_kamar'); ?>" method="post" id="form_edit" data-parsley-validate="true"  autocomplete="off">
    ...
    <script type="text/javascript">
            ...
            $("#input_nama").keyup(function(){
                ...
                if(nama != ''){
                    $.ajax({
                        type: 'GET',
                        dataType: 'json',
                        url: '<?php echo base_url('SuperAdmin/Kategori/cek_nama'); ?>' + '/' + nama,
        ...
        function detail_edit(isi) {
            $.getJSON('<?php echo base_url('SuperAdmin/Kategori/data_edit'); ?>' + '/' + isi, {},
                function(json) {
