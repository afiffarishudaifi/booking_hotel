...
<body>
    ...
    <div id="page-container"
                        ...
                        <div class="panel-body">
                            <table id="data-table-responsive" style="width: 100%" class="table table-striped table-bordered table-td-valign-middle">
                                <thead>
                                    <tr>
                                        <th width="1%">No </th>
                                        <th class="text-nowrap" style="text-align: center;">Fasilitas Kamar</th>
        ...
        <form action="<?= base_url('SuperAdmin/DetailKamar/delete_detail_kamar'); ?>" method="post">
    ...
    <!-- Modal Add Class-->
    <form action="<?= base_url('SuperAdmin/DetailKamar/add_detail_kamar'); ?>" method="post" id="form_add" data-parsley-validate="true">
    ...
    <!-- Modal Edit Class-->
    <form action="<?= base_url('SuperAdmin/DetailKamar/update_detail_kamar'); ?>" method="post" id="form_edit" data-parsley-validate="true">
    ...
    <script type="text/javascript">
        $(function() {
            ...
            $("#input_fasilitas").select2({
                ...
                theme: 'bootstrap4',
                ajax: {
                    url: '<?php echo base_url('SuperAdmin/Detailkamar/data_fasilitas'); ?>',
                    type: "post",
                    delay: 250,
                    dataType: 'json',
        ...
        function detail_edit(isi) {
            $.getJSON('<?= base_url('SuperAdmin/DetailKamar/data_edit'); ?>' + '/' + isi, {},
                function(json) {
                    ...
                    $('#edit_fasilitas').append('<option selected value="' + json.id_fasilitas + '">' + json.nama_fasilitas +
                        '</option>');
                    $('#edit_fasilitas').select2('data', {
                        id: json.id_fasilitas,
                        text: json.nama_fasilitas
                    });
                    $('#edit_fasilitas').trigger('change');
                });
        }
    </script>
</body>
