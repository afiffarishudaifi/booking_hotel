...
<body>
    ...
    <div id="page-container"
                        ...
                        <div class="panel-body">
                            <table id="data-table-responsive" style="width: 100%" class="table table-striped table-bordered table-td-valign-middle">    
                                <thead>
                                    <tr>
                                        <th width="1%">No</th>
                                        <th class="text-nowrap" style="text-align: center;">Foto Kamar</th>
                                ...
                                <tbody>
                                    <?php
                                    $no = 1;
                                    foreach ($foto_kamar as $item) {
                                    ?>
                                    <tr>
                                        <td width="1%"><?= $no++; ?></td>
                                        <td>
                                            <center>
                                                <img class="img-rounded" style="width: 70px;" src="<?= base_url() . '/' .$item['nama_foto']; ?>">
                                            </center>
                                        </td>
                                        <td>
                                            <center>
                                                <a href="" data-toggle="modal" data-toggle="modal" data-target="#updateModal" name="btn-edit" onclick="detail_edit(<?= $item['id_foto']; ?>)" class="btn btn-sm btn-edit btn-warning"><i
                                                        class="fa fa-pen"></i></a>
                                                <a href="" type="button" onclick="Hapus(<?= $item['id_foto']; ?>,<?= $item['id_kamar']; ?>)" class="btn btn-sm btn-danger" id="btn-delete" data-toggle="modal" data-target="#deleteModal"><i class="fa fa-trash"></i></a>
                                            </center>
                                        </td>
                                    </tr>
                                    <?php } ?>
        ...
        <form action="<?php echo base_url('SuperAdmin/Kamar/delete_foto_kamar'); ?>" method="post">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <h4>Apakah Ingin menghapus foto kamar ini?</h4>
        ...
        <form action="<?php echo base_url('SuperAdmin/Kamar/add_foto_kamar'); ?>" method="post" id="form_add" data-parsley-validate="true" enctype="multipart/form-data">
            <div class="modal fade" id="addModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Tambah Foto Kamar </h5>
        ...
        <!-- Modal Edit Class-->
        <form action="<?php echo base_url('SuperAdmin/Kamar/update_foto_kamar'); ?>" method="post" id="form_edit" data-parsley-validate="true" enctype="multipart/form-data">
            <div class="modal fade" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <?= csrf_field(); ?>
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="exampleModalLabel">Ubah Foto Kamar </h5>
                            <button type="reset" class="close" data-dismiss="modal" id="batal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                        </div>
                        <div class="modal-body">
                            <input type="hidden" class="id_kamar" name="id_kamar" id="id_kamar">
                            <input type="hidden" class="id_foto" name="id_foto" id="id_foto">
                            ...
                            <div class="form-group">
                                <label>Foto Kamar</label>
                                <br>
                                <input type="file" id="edit_file" name="edit_file" data-parsley-required="true"  />
                            </div>
    ...
    <script type="text/javascript">
        ...
        function detail_edit(isi) {
            $.getJSON('<?php echo base_url('SuperAdmin/Kamar/data_edit_foto'); ?>' + '/' + isi, {},
                function(json) {
                    // console.log(json);
