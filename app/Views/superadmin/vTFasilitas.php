...
<body>
    ...
    <div id="page-container"
        ...
        <form action="<?php echo base_url('SuperAdmin/Fasilitas/delete_fasilitas'); ?>" method="post">
    ...
    <!-- Modal Add Class-->
    <form action="<?php echo base_url('SuperAdmin/Fasilitas/add_fasilitas'); ?>" method="post" id="form_add" data-parsley-validate="true">
    ...
    <!-- Modal Edit Class-->
    <form action="<?php echo base_url('SuperAdmin/Fasilitas/update_fasilitas'); ?>" method="post" id="form_edit" data-parsley-validate="true">
    ...
    <script type="text/javascript">
            ...
            $("#input_fasilitas").keyup(function(){
                ...
                if(nama != ''){
                    $.ajax({
                        type: 'GET',
                        dataType: 'json',
                        url: '<?php echo base_url('SuperAdmin/Fasilitas/cek_nama'); ?>' + '/' + nama,
        ...
        function detail_edit(isi) {
            $.getJSON('<?php echo base_url('SuperAdmin/Fasilitas/data_edit'); ?>' + '/' + isi, {},
                function(json) {
