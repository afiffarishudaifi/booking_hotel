...
<body>
	...
	<div id="page-container" class="fade page-sidebar-fixed page-header-fixed page-with-wide-sidebar page-with-light-sidebar">
					...
					<div class="row">
						...
						<center>
							...
							<div class="alert alert-danger alert-dismissible fade show col-md-8" role="alert">
                                <center>
                                    <strong>Peringatan!</strong> Item Pemesanan Tidak Ditemukan
                                </center>
                            </div>
						</center> 
						</div>
			...
			<?php } else { ?>
				...
				<div class="invoice">
					...
					<div class="invoice-company">
						<form method="POST" action="<?= base_url('Customer/Keranjang/simpan_pemesanan') ?>">
								<?php foreach ($pemesanan as $item) { ?>
									<input type="hidden" name="id[]" value="<?= $item['id_keranjang'] ?>">
								<?php } ?>
							<span class="pull-right hidden-print">
								<button type="submit" name="simpan_pemesanan" class="btn btn-sm btn-primary m-b-10"><i class="fa fa-print t-plus-1 fa-fw fa-lg"></i> Simpan Pemesanan</button>
							</span>
						</form>
						Hotel Purbaya
					</div>
		...
		<form action="<?= base_url('Customer/Keranjang/delete_pemesanan'); ?>" method="post">
